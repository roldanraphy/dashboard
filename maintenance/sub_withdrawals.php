...
<div class="card card-outline card-primary">
	<div class="card-header">
		<h3 class="card-title">Sub-Agents Withdrawals</h3>
	</div>
	<div class="card-body">
        ...
        <div class="container-fluid">
			<table id ="example" class="table table-hover table-stripped">
				...
				<tbody>
					...
					$qry = $conn->query("SELECT * from withdrawals where active ='Y' and user_id IN (Select id from users where parentid = '{$_settings->userdata('id')}') ");
