			...
			<table class="table table-hover table-stripped" id="example">
				...
				<tbody>
                    ...
                    $bal=0;
                        ...
                        $qry = $conn->query("				select date_created,amount,0.00 red_amount,0.00 blue_amount,0.00 yellow_amount,1 as type,'' winner,'' drawno from loading a where active ='N' and user_id = '{$_settings->userdata('id')}'
									UNION
									select date_created,amount,0.00 red_amount,0.00 blue_amount,0.00 yellow_amount,2 as type,'' winner,'' drawno from withdrawals a where active ='N' and user_id = '{$_settings->userdata('id')}'
									UNION
									select date_created,amount,0.00 red_amount,0.00 blue_amount,0.00 yellow_amount,3 as type,'' winner,'' drawno from coms a where active ='N' and user_id = '{$_settings->userdata('id')}'
									UNION
									...
									from bets a where user_id = '{$_settings->userdata('id')}'
